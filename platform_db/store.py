    ...
    with _LOCK:
        ...
        agents = {
            "memory_rag": {
                ...
                "enabled": 1,
                "tools": ["ask_safety_policy", "check_certification", "list_equipment"],
            },
            "planning": {
                "agent_id": "planning",
                ...
                "enabled": 1,
                "tools": ["check_certification", "check_equipment", "approve_request", "reject_request"],
            },
            "cert_coordination": {
                ...
                "enabled": 1,
                "tools": ["lookup_cert", "schedule_training", "record_result"],
            },
            "high_risk_dig": {
                ...
                "enabled": 1,
                "tools": ["check_soil", "check_depth", "check_cert", "request_supervisor"],
            },
            "incident_handoff": {
                ...
                "enabled": 1,
                "tools": ["log_incident", "assign_investigator", "file_report"],
            },
        }
        for k, v in agents.items():
            db["agent_registry"].setdefault(k, v)
        for w in [
